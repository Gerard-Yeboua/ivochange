            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo '<td><a href="change_role.php?id=' . $row['id'] . '&role=' . ($row['role'] == 'admin' ? 'user' : 'admin') . '" class="btn btn-warning">' . ($row['role'] == 'admin' ? 'Rendre Utilisateur' : 'Rendre Administrateur') . '</a></td>';
                        echo '</tr>';
                    }
                } else {
